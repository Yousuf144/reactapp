...
let question = [{question:"What does HTML stand for",answer:"HTML stands for Hypertext Markup Language."},
{question:"CSS stand for",answer:"Cascading Style Sheet"},
{question:"ES6 stand for",answer:"ECMAScript 6"},{question:"Export type in React",answer:"2"},
{question:"Urdu was declared national language of Pakistan in",answer:'April 1954'},{question:"Bootstrap lattest verison",answer:"5"},
{question:"React Js is",answer:"library"},{question:"______ JavaScript is also called client-side JavaScript",answer:"Navigator"},
{question:" __________ JavaScript is also called server-side JavaScript.",answer:"livewire"},{question:"Which of the following are capabilities of functions in JavaScript?",answer:"Accept parameters"}
]
...
let [fval,setfval] = useState('men')
 ...
 let on = "https://thumbs.dreamstime.com/b/vector-light-bulb-white-file-eps-format-34983265.jpg"
let of = "https://previews.123rf.com/images/ericmilos/ericmilos0912/ericmilos091200136/6109526-3d-render-of-light-bulb-on-white.jpg"

let [bul,setbul] = useState(on)
...
let vala = e =>{
  ...
  return (
    ...
    <div className="productcontainer">
      ...
      <div>
      <img src={bul} width="200px" height="200px" />
